      ...
      <div className="lp-hero">
        ...
        <header className="lp-header">
          <div className="lp-brand">
            <h1 className="lp-title">SolarPower Forecaster</h1>
        ...
        <section className="lp-hero-content">
          <div className="lp-hero-left">
            ...
            <div className="lp-cta-row">
              ...
              <button className="lp-btn lp-outline">View Repo</button>
            </div>
          </div>
        ...
        <div className="lp-container">
          ...
          <div className="lp-grid">
            <article className="lp-card">
              ...
              <p>Multiple models (Linear, RandomForest, XGBoost, LSTM) with model comparison and metrics (MAE, RMSE, R²).</p>
            </article>

            <article className="lp-card">
              <h4>🌦️ Weather API Integration</h4>
              <p>Plug in OpenWeatherMap, Meteostat or NASA Power — uses cloud cover, irradiance and temperature in predictions.</p>
            </article>

            <article className="lp-card">
              <h4>📈 Interactive Dashboard</h4>
              <p>Actual vs. predicted charts, download CSV/PDF reports, and an exportable summary for stakeholders.</p>
            </article>
          </div>
